...
if TYPE_CHECKING:
    from ..models.get_jobs_response_200_detail import GetJobsResponse200Detail
...
class GetJobsResponse200:
    """
    Attributes:
        detail (GetJobsResponse200Detail | Unset):
        message (str | Unset):
    """

    detail: GetJobsResponse200Detail | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_detail, Unset):
            ...
            detail = GetJobsResponse200Detail.from_dict(_detail)
